...
const LOGOS = {
  ...
  perplexity: `<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"><path d="M22.3977 7.0896h-2.3106V.0676l-7.5094 6.3542V.1577h-1.1554v6.4533L4.4904.1577v6.9319H2.1798v10.9354h2.8125V24l6.6939-5.7558v5.6921h1.1554v-5.6516L19.5841 24v-6.0233h2.8136V7.0896zm-3.4663-4.7095v4.7095h-5.567l5.567-4.7095zm-6.5395 4.7095l-5.5957-4.7395v4.7395h5.5957zm-3.4664 9.3358h-3.7547V8.246h7.5093v9.6584l-4.3107-3.7059-3.4439 3.0834zm6.4521-3.6855l4.2902-3.6839V17.97h-4.7568l.4666-1.5198zm5.5754 6.2245l-4.5535-4.8896h4.5535v4.8896z"/></svg>`,
};
